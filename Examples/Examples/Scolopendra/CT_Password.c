	...
	{	
		switch(cStep)
		{
			...
			case PASSWORD_ENTER_USERNAME:					
				cTemp=CT_InputAnything(userName,"Usuario",2);
			...
			case PASSWORD_ENTER_CURRENT_PASSWORD:					
				cTemp=CT_InputAnything(userPass,"Clave actual",3);
				if(cTemp==0xFB)
			...
			case PASSWORD_ENTER_NEW_PASSWORD:
				cTemp=CT_InputAnything(userNewPass,"Nueva clave",3);
				if(cTemp==0xFB)
			...
			case PASSWORD_CONFIRM_NEW_PASSWORD:
				cTemp=CT_InputAnything(userConfirmNewPass,"Confirme clave",3);
				if(cTemp==0xFB)
