	...
	{	
		switch(cStep)
		{
			...
			case DEPOSIT_CONTROL_NUMBER:					
				...
				cTemp=CT_InputAnything(depositControlNumber,"Numero de Deposito",1);
				if(cTemp==0xFB)
			...
			case DEPOSIT_ADD_AMOUNT:					
				...
				cTemp=CT_InputAnything(depositAmount, "Monto de Deposito", 0);
				if(cTemp==0xFB){
			...
			case DEPOSIT_ADD_DATE:					
				...
				cTemp=CT_InputAnything(dateDep,"Fecha del deposito",4);
				if(cTemp==0xFB)
