...
uint8 CT_InputDate(char* result, char* header){
	return CT_InputAnything(result,header,CT_DATE);
}

uint8 CT_InputIP(char* result, char* header){
	return CT_InputAnything(result,header,CT_IP);
}
